      ...
      >
        <Grid container columnSpacing={{ md: 3 }} sx={{ alignItems: 'flex-start' }}>
          ...
          <Grid size={{ xs: 12, md: 6, lg: 5 }}>
            ...
            >
              Бид хэрэглэгчийн хүссэн лого, зураг, дизайныг өндөр чанартай бүтээгдэхүүн дээр
              байршуулж, таны хэрэгцээнд бүрэн нийцсэн бүтээгдэхүүн санал болгодог.
              Чанартай материал, орчин үеийн технологийг хослуулан боломжийн үнээр хүргэдэг нь
              бидний давуу тал юм.
            </Typography>
...
const SKILLS = [
  { value: 40, label: 'Дизайн' },
  { value: 30, label: 'Үйлдвэрлэл' },
  { value: 30, label: 'Маркетинг' },
];
